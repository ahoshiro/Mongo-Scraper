...
const helpers = require("../utils/helpers.js"); // Requiring our helper for making API calls
const Search = React.createClass({ // Create the Search Component
